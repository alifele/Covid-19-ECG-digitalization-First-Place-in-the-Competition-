            ...
            <div class="row">
                ...
                <ul class="list-inline"> 
                        <li>
                            ...
                            <?php if (get_theme_mod('fsars_medical_phone')) { ?>
                                <i class="fa fa-phone"></i>&nbsp;&nbsp;<?php echo esc_html($fsars_medical_phone); ?>
                            <?php } ?>
                        </li>
                        <li>
                            <?php $fsars_medical_email = get_theme_mod('fsars_medical_address'); ?>
                            <?php if (get_theme_mod('fsars_medical_address')) { ?>
                                <i class="fa fa-map-marker"></i>&nbsp;&nbsp;<?php echo esc_html(sanitize_email($fsars_medical_email)); ?>
                            <?php } ?>                             
                        </li>
                    </ul>
