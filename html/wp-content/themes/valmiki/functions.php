...
define('VALMIKI_THEME_URL','https://wpkoi.com/valmiki-wpkoi-wordpress-theme/');
define('VALMIKI_WPKOI_AUTHOR_URL','https://wpkoi.com/');
define('VALMIKI_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/');
define('VALMIKI_WORDPRESS_REVIEW','https://wordpress.org/support/theme/valmiki/reviews/?filter=5');
define('VALMIKI_DOCUMENTATION','https://wpkoi.com/docs/');