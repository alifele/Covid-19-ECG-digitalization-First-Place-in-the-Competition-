              ...
              <div class="inner_carousel">
                ...
                <?php if ( get_theme_mod('medical_hospital_slider_button_label','READ MORE') != '' && get_theme_mod('medical_hospital_slider_button',true) != '') {?>
                  <div class ="readbutton">
                    <a href="<?php esc_url(the_permalink()); ?>"> <?php echo esc_html( get_theme_mod('medical_hospital_slider_button_label',__('READ MORE','medical-hospital')) ); ?><span class="screen-reader-text"><?php echo esc_html( get_theme_mod('medical_hospital_slider_button_label',__('READ MORE','medical-hospital')) ); ?></span></a>
                  </div>
                <?php }?>
              </div>
            </div>
              ...
              <?php while( $page_query->have_posts() ) : $page_query->the_post(); ?>
                  <div class="col-lg-3 col-md-6 main-service-box">
                    <div class="service-box">
                      ...
                      <a href="<?php esc_url(the_permalink()); ?>"><i class="fas fa-arrow-right"></i><span class="screen-reader-text"><?php esc_html_e( 'READ MORE', 'medical-hospital' ); ?></span></a>
                    </div>
                  </div>
              <?php endwhile;
              wp_reset_postdata();
            ...
            while ( $query->have_posts() ) : $query->the_post(); ?>
              <div class="row m-0">
                <div class="col-lg-8 col-md-8">
                  <h2><a href="<?php esc_url(the_permalink()); ?>"><?php esc_html(the_title()); ?><span class="screen-reader-text"><?php esc_html(the_title()); ?></a></h2>
                  ...
                  <div class="textbox">
                    <p><?php the_excerpt(); ?></p>
                    <a href="<?php esc_url(the_permalink()); ?>"><?php esc_html_e('FIND OUT MORE','medical-hospital'); ?><span class="screen-reader-text"><?php esc_html_e( 'FIND OUT MORE', 'medical-hospital' ); ?></span></a>
                  </div>
                </div> 
                <div class="col-lg-4 col-md-4">
                  <div class="abt-image">
